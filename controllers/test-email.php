...
$email_detail = array(
	'firstname' => 'DavidArr',
	'lastname' => 'ChanArr',
	'appoint_date' => '25/12/2014',
	'appoint_time' => '15:00',
	'venue' => 'Shell Street,"End of Address'
);
echo "Test Begins. <br />";
//send_register_email($to,$fname,$lname,$pwd);
//send_reset_password_email($to,$fname,$lname,$pwd);
//booking_customer_email($to,$eventName,$bookingID,$email_detail,$action);
//delete_booking_customer_email($to,$eventName,$bookingID,$email_detail,$action);
//send_booking_cs_email('david@fern.com.hk','BookingEventName','AUD001','test-david','created');
echo "Test Ended. <br />";
*/
?>
